/*
 ...
 T. van Beelen's rs232 libraray, slightly modifed
 under GPL license by Klaus-Peter Zauner, 2014:
   - Under Windows the parameter 'comport_number' now corresponds
     to the n in the machines 'COMn' port labeling. This makes it easier
     to adjust to the frequently changing comport labels under Windows.
     Comport numbers up to COM512 are supported.
...
#define MAX_COMPORT_NUM 512
#define MAX_COMPORT_LABEL_LENGTH 12


HANDLE Cport[MAX_COMPORT_NUM];

char comports[MAX_COMPORT_LABEL_LENGTH];
